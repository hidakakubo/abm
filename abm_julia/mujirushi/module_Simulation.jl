include("module_Society.jl")
include("module_Decision.jl")
...
module Simulation
    ...
    # 色々なseedでアンサンブル平均を取る
    function main(iteration, firstsize, Nmax, life_length, cool_time, init_male_prop, accident_rate_array, born_rate_array, seeds) # seeds要る？
...
@time main(iteration, firstsize, Nmax, life_length, cool_time, init_male_prop, accident_rate_array, born_rate_array, seeds)