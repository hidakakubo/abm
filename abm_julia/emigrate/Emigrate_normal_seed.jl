...
module Simulation
    ...
    # シミュレーション実行
    function run_one_episode(society, iteration, firstsize, Nmax, life_length, cool_time, old_time, kosodate_time, init_male_prop, go_out_rate, accident_rate, born_rate, seed)
    ...
    function main(iteration, firstsize, Nmax, life_length, cool_time, old_time, kosodate_time, init_male_prop, go_out_rate, accident_rate, born_rate, seeds)
        for seed = 1:length(seeds)
            ...
            run_one_episode(society, iteration, firstsize, Nmax, life_length, cool_time, old_time, kosodate_time, init_male_prop, go_out_rate, accident_rate, born_rate, seed)
